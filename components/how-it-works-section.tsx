      ...
      <div className="container mx-auto px-8 max-w-7xl">
        ...
        <div className="grid lg:grid-cols-3 gap-12 max-w-6xl mx-auto">
          <div className="relative">
            <div className="absolute -top-6 -left-6 text-8xl font-bold text-primary/10">1</div>
            <div className="relative z-10">
              <div className="mb-6 text-primary ml-10">
              ...
              <p className="text-muted-foreground leading-relaxed font-light text-lg mb-4">
          ...
          <div className="relative">
            <div className="absolute -top-6 -left-6 text-8xl font-bold text-primary/10">2</div>
            <div className="relative z-10">
              <div className="mb-6 text-accent ml-10">
                <svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.2}>
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
          ...
          <div className="relative">
            <div className="absolute -top-6 -left-6 text-8xl font-bold text-primary/10">3</div>
            <div className="relative z-10">
              <div className="mb-6 text-primary ml-10">
                <svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.2}>
                  <path

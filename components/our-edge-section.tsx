    ...
    <section id="features" className="py-16 sm:py-24 md:py-32 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 max-w-7xl relative z-10">
        <div className="text-center mb-12 sm:mb-16 md:mb-20">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-medium mb-3 sm:mb-4 text-balance leading-[1.15] text-foreground tracking-tight">
            Ancient wisdom. Powered by the future.
          </h2>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-muted-foreground font-light">This isn't magic. It's precision.</p>
        </div>

        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 md:gap-16 lg:gap-20 items-center mb-12 sm:mb-16 md:mb-24">
          ...
          <div className="order-1 lg:order-2">
            ...
            <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-medium mb-4 sm:mb-6 md:mb-8 text-balance leading-tight text-foreground tracking-tight">
              The Vedic + KP System
            </h3>
            <p className="text-base sm:text-lg md:text-xl text-muted-foreground leading-relaxed mb-4 sm:mb-6 font-light">
              Most astrology stops at zodiac signs. We go deeper with Vedic precision.
            </p>
            <p className="text-sm sm:text-base md:text-lg text-muted-foreground leading-relaxed mb-4 sm:mb-6 font-light">
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 md:gap-16 lg:gap-20 items-center mb-12 sm:mb-16 md:mb-24">
          ...
          <div className="relative">
            <div className="relative z-10 rounded-xl sm:rounded-2xl md:rounded-[2rem] overflow-hidden border border-amber-900/20 shadow-2xl bg-gradient-to-br from-amber-950/30 to-orange-950/30 p-12 sm:p-16 md:p-20 flex items-center justify-center">
              <svg
                className="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 text-amber-600/30"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth={0.5}
